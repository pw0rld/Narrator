...
123.56.73.249:3385:5:se_slave
123.56.73.249:3384:6:se_slave
121.41.42.28:3389:11:se_slave
121.41.42.28:3388:12:se_slave
121.41.42.28:3387:13:se_slave
121.41.42.28:3386:14:se_slave
121.41.42.28:3385:15:se_slave
...
run_narrator_serverenclave() {
    ...
    # sleep 1
    # Wlan
    nohup ./host/attestation_host ./enclave/enclave_a.signed 3389 ../host/network/_peers 121.41.42.28 &  
    sleep 1
    nohup ./host/attestation_host ./enclave/enclave_a.signed 3388 ../host/network/_peers 121.41.42.28 >> /tmp/SE1log 2>&1 & 
    sleep 1
    nohup ./host/attestation_host ./enclave/enclave_a.signed 3387 ../host/network/_peers 121.41.42.28 >> /tmp/SE2log 2>&1 & 
    sleep 1
    nohup ./host/attestation_host ./enclave/enclave_a.signed 3386 ../host/network/_peers 121.41.42.28 >> /tmp/SE3log 2>&1 & 
    sleep 1
    nohup ./host/attestation_host ./enclave/enclave_a.signed 3385 ../host/network/_peers 121.41.42.28 >> /tmp/SE4log 2>&1 & 
    sleep 1
    nohup ./host/attestation_host ./enclave/enclave_a.signed 3384 ../host/network/_peers 121.41.42.28 >> /tmp/SE5log 2>&1 & 
    "
}
