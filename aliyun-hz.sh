...
112.124.17.142:3387:13:se_slave
112.124.17.142:3386:14:se_slave
...
run_narrator_serverenclave() {
    ...
    # sleep 1
    # Wlan
    nohup ./host/attestation_host ./enclave/enclave_a.signed 3389 ../host/network/_peers 112.124.17.142 &  
    sleep 1
    ...
    sleep 1
    #nohup ./host/attestation_host ./enclave/enclave_a.signed 3385 ../host/network/_peers 112.124.17.142 >> /tmp/SE4log 2>&1 & 
    sleep 1
    #nohup ./host/attestation_host ./enclave/enclave_a.signed 3384 ../host/network/_peers 112.124.17.142 >> /tmp/SE5log 2>&1 & 
    "
}
