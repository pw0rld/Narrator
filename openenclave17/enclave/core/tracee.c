...
oe_result_t oe_log(oe_log_level_t level, const char* fmt, ...)
{
    ...
    //- TODO: This is an infinite loop. When memory is used up, 
    //- the following code call OE_RAISE, and OE_RAISE, however,
    //- will call oe_log func again. Apparently, oe_malloc error
    //- will happen again.
