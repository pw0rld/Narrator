...
enum sec_return_code_e {
	...
	SEC_INVALID_INPUT_PARAM,	// API received an invalid input param
	...
	SEC_LAST_DESCRIPTOR_IN_FLIGHT,	// API function indicates there is one
					//   last descriptor in flight for SEC
					//   to process that
