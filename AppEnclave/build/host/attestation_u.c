...
enum
{
    ...
    attestation_fcn_id_verify_evidence = 2,
    attestation_fcn_id_rsa_encrypt_aes_key = 3,
    attestation_fcn_id_aes_encrypt_client_messages = 4,
    attestation_fcn_id_seal_state_data = 5,
    attestation_fcn_id_unseal_state_data = 6,
    attestation_fcn_id_aes_decrypt_server_messages = 7,
    attestation_fcn_id_oe_verify_report_ecall = 8,
    attestation_fcn_id_oe_get_sgx_report_ecall = 9,
    attestation_fcn_id_oe_get_report_v2_ecall = 10,
    attestation_fcn_id_oe_verify_local_report_ecall = 11,
    attestation_fcn_id_oe_sgx_init_context_switchless_ecall = 12,
    attestation_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall = 13,
...
static const oe_ecall_info_t _attestation_ecall_info_table[] = 
{
    ...
    { "verify_evidence" },
    { "rsa_encrypt_aes_key" },
    { "aes_encrypt_client_messages" },
    { "seal_state_data" },
    { "unseal_state_data" },
    { "aes_decrypt_server_messages" },
...
typedef struct _verify_evidence_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t uuid;
} verify_evidence_args_t;

typedef struct _rsa_encrypt_aes_key_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
} rsa_encrypt_aes_key_args_t;

typedef struct _aes_encrypt_client_messages_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    uint8_t** mrenclave;
    size_t* mrenclave_size;
} aes_encrypt_client_messages_args_t;

typedef struct _seal_state_data_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
} seal_state_data_args_t;

typedef struct _unseal_state_data_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    unsigned char** data;
    size_t* data_size;
} unseal_state_data_args_t;

typedef struct _aes_decrypt_server_messages_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
    ...
    size_t* is_ready;
} aes_decrypt_server_messages_args_t;
    ...
    size_t* format_settings_size)
{
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(format_settings, 1, sizeof(uint8_t*));
    OE_READ_OUT_PARAM(format_settings_size, 1, sizeof(size_t));
    ...
    size_t* evidence_buffer_size)
{
    ...
    if (format_settings_buffer)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.format_settings_size);
    ...
    if (format_id)
        OE_WRITE_IN_PARAM(format_id, 1, sizeof(oe_uuid_t), oe_uuid_t*);
    if (format_settings_buffer)
        OE_WRITE_IN_PARAM(format_settings_buffer, 1, _args.format_settings_size, uint8_t*);
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(pem_key, 1, sizeof(uint8_t*));
    OE_READ_OUT_PARAM(pem_key_size, 1, sizeof(size_t));
    OE_READ_OUT_PARAM(evidence_buffer, 1, sizeof(uint8_t*));
    OE_READ_OUT_PARAM(evidence_buffer_size, 1, sizeof(size_t));
...
oe_result_t attestation_verify_evidence(
    oe_enclave_t* enclave,
    int* _retval,
    const oe_uuid_t* format_id,
    uint8_t* pem_key,
    ...
    size_t uuid)
{
    ...
    /* Marshalling struct. */
    verify_evidence_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(verify_evidence_args_t));
    if (format_id)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, sizeof(oe_uuid_t));
    if (pem_key)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.pem_key_size, sizeof(uint8_t));
    if (evidence)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.evidence_size, sizeof(uint8_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(verify_evidence_args_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (verify_evidence_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (format_id)
        OE_WRITE_IN_PARAM(format_id, 1, sizeof(oe_uuid_t), oe_uuid_t*);
    if (pem_key)
        OE_WRITE_IN_PARAM(pem_key, _args.pem_key_size, sizeof(uint8_t), uint8_t*);
    if (evidence)
        OE_WRITE_IN_PARAM(evidence, _args.evidence_size, sizeof(uint8_t), uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_verify_evidence].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (verify_evidence_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(attestation_verify_evidence, verify_evidence);

oe_result_t attestation_rsa_encrypt_aes_key(
    oe_enclave_t* enclave,
    int* _retval,
    uint8_t** encrypt_aes_data,
    size_t* encrypt_aes_data_size,
    ...
    size_t* mrenclave_size)
{
    ...
    /* Marshalling struct. */
    rsa_encrypt_aes_key_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.encrypt_aes_data = (uint8_t**)encrypt_aes_data;
    _args.encrypt_aes_data_size = (size_t*)encrypt_aes_data_size;
    _args.mrenclave = (uint8_t**)mrenclave;
    _args.mrenclave_size = (size_t*)mrenclave_size;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(rsa_encrypt_aes_key_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(rsa_encrypt_aes_key_args_t));
    if (encrypt_aes_data)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(uint8_t*));
    if (encrypt_aes_data_size)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(size_t));
    if (mrenclave)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(uint8_t*));
    if (mrenclave_size)
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (rsa_encrypt_aes_key_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_rsa_encrypt_aes_key].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (rsa_encrypt_aes_key_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(encrypt_aes_data, 1, sizeof(uint8_t*));
    OE_READ_OUT_PARAM(encrypt_aes_data_size, 1, sizeof(size_t));
    OE_READ_OUT_PARAM(mrenclave, 1, sizeof(uint8_t*));
    OE_READ_OUT_PARAM(mrenclave_size, 1, sizeof(size_t));
...
OE_WEAK_ALIAS(attestation_rsa_encrypt_aes_key, rsa_encrypt_aes_key);

oe_result_t attestation_aes_encrypt_client_messages(
    oe_enclave_t* enclave,
    int* _retval,
    uint8_t* requests_message,
    size_t requests_message_size,
    ...
    size_t* mrenclave_size)
{
    ...
    /* Marshalling struct. */
    aes_encrypt_client_messages_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.requests_message = (uint8_t*)requests_message;
    _args.requests_message_size = requests_message_size;
    _args.encrypt_aes_data = (uint8_t**)encrypt_aes_data;
    _args.encrypt_aes_data_size = (size_t*)encrypt_aes_data_size;
    _args.mrenclave = (uint8_t**)mrenclave;
    _args.mrenclave_size = (size_t*)mrenclave_size;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(aes_encrypt_client_messages_args_t));
    if (requests_message)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.requests_message_size, sizeof(uint8_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(aes_encrypt_client_messages_args_t));
    if (encrypt_aes_data)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(uint8_t*));
    if (encrypt_aes_data_size)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(size_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (aes_encrypt_client_messages_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (requests_message)
        OE_WRITE_IN_PARAM(requests_message, _args.requests_message_size, sizeof(uint8_t), uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_aes_encrypt_client_messages].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (aes_encrypt_client_messages_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
...
OE_WEAK_ALIAS(attestation_aes_encrypt_client_messages, aes_encrypt_client_messages);

oe_result_t attestation_seal_state_data(
    oe_enclave_t* enclave,
    int* _retval,
    int sealPolicy,
    sealed_data_t** sealed_data,
    size_t* sealed_data_size)
{
    ...
    /* Marshalling struct. */
    seal_state_data_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(seal_state_data_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(seal_state_data_args_t));
    if (sealed_data)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(sealed_data_t*));
    if (sealed_data_size)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(size_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (seal_state_data_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_seal_state_data].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (seal_state_data_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(sealed_data, 1, sizeof(sealed_data_t*));
    OE_READ_OUT_PARAM(sealed_data_size, 1, sizeof(size_t));
...
OE_WEAK_ALIAS(attestation_seal_state_data, seal_state_data);

oe_result_t attestation_unseal_state_data(
    oe_enclave_t* enclave,
    int* _retval,
    sealed_data_t* sealed_data,
    size_t sealed_data_size,
    ...
    size_t* data_size)
{
    ...
    /* Marshalling struct. */
    unseal_state_data_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(unseal_state_data_args_t));
    if (sealed_data)
        OE_ADD_ARG_SIZE(_input_buffer_size, 1, _args.sealed_data_size);
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(unseal_state_data_args_t));
    if (data)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(unsigned char*));
    if (data_size)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(size_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (unseal_state_data_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (sealed_data)
        OE_WRITE_IN_PARAM(sealed_data, 1, _args.sealed_data_size, sealed_data_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_unseal_state_data].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (unseal_state_data_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(data, 1, sizeof(unsigned char*));
    OE_READ_OUT_PARAM(data_size, 1, sizeof(size_t));
...
OE_WEAK_ALIAS(attestation_unseal_state_data, unseal_state_data);

oe_result_t attestation_aes_decrypt_server_messages(
    oe_enclave_t* enclave,
    int* _retval,
    uint8_t* reply_data,
    size_t reply_data_size,
    size_t* is_ready)
{
    ...
    /* Marshalling struct. */
    aes_decrypt_server_messages_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    /* Fill marshalling struct. */
    memset(&_args, 0, sizeof(_args));
    _args.reply_data = (uint8_t*)reply_data;
    _args.reply_data_size = reply_data_size;
    _args.is_ready = (size_t*)is_ready;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(aes_decrypt_server_messages_args_t));
    if (reply_data)
        OE_ADD_ARG_SIZE(_input_buffer_size, _args.reply_data_size, sizeof(uint8_t));
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(aes_decrypt_server_messages_args_t));
    if (is_ready)
        OE_ADD_ARG_SIZE(_output_buffer_size, 1, sizeof(size_t));
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (aes_decrypt_server_messages_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    if (reply_data)
        OE_WRITE_IN_PARAM(reply_data, _args.reply_data_size, sizeof(uint8_t), uint8_t*);
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _attestation_ecall_info_table[attestation_fcn_id_aes_decrypt_server_messages].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (aes_decrypt_server_messages_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(is_ready, 1, sizeof(size_t));
...
OE_WEAK_ALIAS(attestation_aes_decrypt_server_messages, aes_decrypt_server_messages);
...
enum
{
    attestation_fcn_id_seal_host_write = 0,
    attestation_fcn_id_oe_syscall_epoll_create1_ocall = 1,
    attestation_fcn_id_oe_syscall_epoll_wait_ocall = 2,
    attestation_fcn_id_oe_syscall_epoll_wake_ocall = 3,
    attestation_fcn_id_oe_syscall_epoll_ctl_ocall = 4,
    attestation_fcn_id_oe_syscall_epoll_close_ocall = 5,
    attestation_fcn_id_oe_syscall_open_ocall = 6,
    attestation_fcn_id_oe_syscall_read_ocall = 7,
    attestation_fcn_id_oe_syscall_write_ocall = 8,
    attestation_fcn_id_oe_syscall_readv_ocall = 9,
    attestation_fcn_id_oe_syscall_writev_ocall = 10,
    attestation_fcn_id_oe_syscall_lseek_ocall = 11,
    attestation_fcn_id_oe_syscall_pread_ocall = 12,
    attestation_fcn_id_oe_syscall_pwrite_ocall = 13,
    attestation_fcn_id_oe_syscall_close_ocall = 14,
    attestation_fcn_id_oe_syscall_flock_ocall = 15,
    attestation_fcn_id_oe_syscall_fsync_ocall = 16,
    attestation_fcn_id_oe_syscall_fdatasync_ocall = 17,
    attestation_fcn_id_oe_syscall_dup_ocall = 18,
    attestation_fcn_id_oe_syscall_opendir_ocall = 19,
    attestation_fcn_id_oe_syscall_readdir_ocall = 20,
    attestation_fcn_id_oe_syscall_rewinddir_ocall = 21,
    attestation_fcn_id_oe_syscall_closedir_ocall = 22,
    attestation_fcn_id_oe_syscall_stat_ocall = 23,
    attestation_fcn_id_oe_syscall_fstat_ocall = 24,
    attestation_fcn_id_oe_syscall_access_ocall = 25,
    attestation_fcn_id_oe_syscall_link_ocall = 26,
    attestation_fcn_id_oe_syscall_unlink_ocall = 27,
    attestation_fcn_id_oe_syscall_rename_ocall = 28,
    attestation_fcn_id_oe_syscall_truncate_ocall = 29,
    attestation_fcn_id_oe_syscall_ftruncate_ocall = 30,
    attestation_fcn_id_oe_syscall_mkdir_ocall = 31,
    attestation_fcn_id_oe_syscall_rmdir_ocall = 32,
    attestation_fcn_id_oe_syscall_fcntl_ocall = 33,
    attestation_fcn_id_oe_syscall_ioctl_ocall = 34,
    attestation_fcn_id_oe_syscall_poll_ocall = 35,
    attestation_fcn_id_oe_syscall_kill_ocall = 36,
    attestation_fcn_id_oe_syscall_close_socket_ocall = 37,
    attestation_fcn_id_oe_syscall_socket_ocall = 38,
    attestation_fcn_id_oe_syscall_shutdown_sockets_device_ocall = 39,
    attestation_fcn_id_oe_syscall_socketpair_ocall = 40,
    attestation_fcn_id_oe_syscall_connect_ocall = 41,
    attestation_fcn_id_oe_syscall_accept_ocall = 42,
    attestation_fcn_id_oe_syscall_bind_ocall = 43,
    attestation_fcn_id_oe_syscall_listen_ocall = 44,
    attestation_fcn_id_oe_syscall_recvmsg_ocall = 45,
    attestation_fcn_id_oe_syscall_sendmsg_ocall = 46,
    attestation_fcn_id_oe_syscall_recv_ocall = 47,
    attestation_fcn_id_oe_syscall_recvfrom_ocall = 48,
    attestation_fcn_id_oe_syscall_send_ocall = 49,
    attestation_fcn_id_oe_syscall_sendto_ocall = 50,
    attestation_fcn_id_oe_syscall_recvv_ocall = 51,
    attestation_fcn_id_oe_syscall_sendv_ocall = 52,
    attestation_fcn_id_oe_syscall_shutdown_ocall = 53,
    attestation_fcn_id_oe_syscall_setsockopt_ocall = 54,
    attestation_fcn_id_oe_syscall_getsockopt_ocall = 55,
    attestation_fcn_id_oe_syscall_getsockname_ocall = 56,
    attestation_fcn_id_oe_syscall_getpeername_ocall = 57,
    attestation_fcn_id_oe_syscall_getaddrinfo_open_ocall = 58,
    attestation_fcn_id_oe_syscall_getaddrinfo_read_ocall = 59,
    attestation_fcn_id_oe_syscall_getaddrinfo_close_ocall = 60,
    attestation_fcn_id_oe_syscall_getnameinfo_ocall = 61,
    attestation_fcn_id_oe_syscall_nanosleep_ocall = 62,
    attestation_fcn_id_oe_syscall_clock_nanosleep_ocall = 63,
    attestation_fcn_id_oe_syscall_getpid_ocall = 64,
    attestation_fcn_id_oe_syscall_getppid_ocall = 65,
    attestation_fcn_id_oe_syscall_getpgrp_ocall = 66,
    attestation_fcn_id_oe_syscall_getuid_ocall = 67,
    attestation_fcn_id_oe_syscall_geteuid_ocall = 68,
    attestation_fcn_id_oe_syscall_getgid_ocall = 69,
    attestation_fcn_id_oe_syscall_getegid_ocall = 70,
    attestation_fcn_id_oe_syscall_getpgid_ocall = 71,
    attestation_fcn_id_oe_syscall_getgroups_ocall = 72,
    attestation_fcn_id_oe_syscall_uname_ocall = 73,
    attestation_fcn_id_oe_get_supported_attester_format_ids_ocall = 74,
    attestation_fcn_id_oe_get_qetarget_info_ocall = 75,
    attestation_fcn_id_oe_get_quote_ocall = 76,
    attestation_fcn_id_oe_get_quote_verification_collateral_ocall = 77,
    ...
    attestation_fcn_id_oe_sgx_thread_wake_wait_ocall = 81,
    attestation_fcn_id_oe_sgx_wake_switchless_worker_ocall = 82,
    attestation_fcn_id_oe_sgx_sleep_switchless_worker_ocall = 83,
    attestation_fcn_id_untrusted_call_max = OE_ENUM_MAX
};

/**** OCALL marshalling structs. ****/
typedef struct _seal_host_write_args_t
{
    oe_result_t oe_result;
    uint8_t* deepcopy_out_buffer;
    size_t deepcopy_out_buffer_size;
...
static void ocall_seal_host_write(
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    seal_host_write_args_t* _pargs_in = (seal_host_write_args_t*)input_buffer;
    seal_host_write_args_t* _pargs_out = (seal_host_write_args_t*)output_buffer;
    ...
    if (_pargs_in->sealed_data)
        OE_SET_OUT_POINTER(sealed_data, 1, sizeof(unsigned char), unsigned char*);

    /* Call user function. */
    _pargs_out->oe_retval = seal_host_write(
        _pargs_in->sealed_data_size,
        _pargs_in->sealed_data);
...
static oe_ocall_func_t _attestation_ocall_function_table[] = {
    (oe_ocall_func_t) ocall_seal_host_write,
