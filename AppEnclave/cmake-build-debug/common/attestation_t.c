    ...
    size_t* output_bytes_written)
{
    ...
    if (_pargs_in->format_settings)
        OE_SET_OUT_POINTER(format_settings, 1, sizeof(uint8_t*), uint8_t**);
    if (_pargs_in->format_settings_size)
        OE_SET_OUT_POINTER(format_settings_size, 1, sizeof(size_t), size_t*);
    ...
    _pargs_out->oe_retval = get_enclave_format_settings(
        ...
        _pargs_in->format_settings_size);
    ...
    size_t* output_bytes_written)
{
    ...
    if (_pargs_in->format_id)
        OE_SET_IN_POINTER(format_id, 1, sizeof(oe_uuid_t), oe_uuid_t*);
    if (_pargs_in->format_settings_buffer)
        OE_SET_IN_POINTER(format_settings_buffer, 1, _pargs_in->format_settings_size, uint8_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->pem_key)
        OE_SET_OUT_POINTER(pem_key, 1, sizeof(uint8_t*), uint8_t**);
    if (_pargs_in->pem_key_size)
        OE_SET_OUT_POINTER(pem_key_size, 1, sizeof(size_t), size_t*);
    if (_pargs_in->evidence_buffer)
        OE_SET_OUT_POINTER(evidence_buffer, 1, sizeof(uint8_t*), uint8_t**);
    if (_pargs_in->evidence_buffer_size)
        OE_SET_OUT_POINTER(evidence_buffer_size, 1, sizeof(size_t), size_t*);
    ...
    _pargs_out->oe_retval = get_evidence_with_public_key(
        (const oe_uuid_t*)_pargs_in->format_id,
        _pargs_in->format_settings_buffer,
        _pargs_in->format_settings_size,
        _pargs_in->pem_key,
        _pargs_in->pem_key_size,
        _pargs_in->evidence_buffer,
        _pargs_in->evidence_buffer_size);
...
static void ecall_verify_evidence(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    verify_evidence_args_t* _pargs_in = (verify_evidence_args_t*)input_buffer;
    verify_evidence_args_t* _pargs_out = (verify_evidence_args_t*)output_buffer;
    ...
    if (_pargs_in->format_id)
        OE_SET_IN_POINTER(format_id, 1, sizeof(oe_uuid_t), oe_uuid_t*);
    if (_pargs_in->pem_key)
        OE_SET_IN_POINTER(pem_key, _pargs_in->pem_key_size, sizeof(uint8_t), uint8_t*);
    if (_pargs_in->evidence)
        OE_SET_IN_POINTER(evidence, _pargs_in->evidence_size, sizeof(uint8_t), uint8_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = verify_evidence(
        (const oe_uuid_t*)_pargs_in->format_id,
        _pargs_in->pem_key,
        _pargs_in->pem_key_size,
        _pargs_in->evidence,
        _pargs_in->evidence_size,
        _pargs_in->uuid);
...
static void ecall_rsa_encrypt_aes_key(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    rsa_encrypt_aes_key_args_t* _pargs_in = (rsa_encrypt_aes_key_args_t*)input_buffer;
    rsa_encrypt_aes_key_args_t* _pargs_out = (rsa_encrypt_aes_key_args_t*)output_buffer;
    ...
    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->encrypt_aes_data)
        OE_SET_OUT_POINTER(encrypt_aes_data, 1, sizeof(uint8_t*), uint8_t**);
    if (_pargs_in->encrypt_aes_data_size)
        OE_SET_OUT_POINTER(encrypt_aes_data_size, 1, sizeof(size_t), size_t*);
    if (_pargs_in->mrenclave)
        OE_SET_OUT_POINTER(mrenclave, 1, sizeof(uint8_t*), uint8_t**);
    if (_pargs_in->mrenclave_size)
        OE_SET_OUT_POINTER(mrenclave_size, 1, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = rsa_encrypt_aes_key(
        _pargs_in->encrypt_aes_data,
        _pargs_in->encrypt_aes_data_size,
        _pargs_in->mrenclave,
        _pargs_in->mrenclave_size);
...
static void ecall_aes_encrypt_client_messages(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    aes_encrypt_client_messages_args_t* _pargs_in = (aes_encrypt_client_messages_args_t*)input_buffer;
    aes_encrypt_client_messages_args_t* _pargs_out = (aes_encrypt_client_messages_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->requests_message)
        OE_SET_IN_POINTER(requests_message, _pargs_in->requests_message_size, sizeof(uint8_t), uint8_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = aes_encrypt_client_messages(
        _pargs_in->requests_message,
        _pargs_in->requests_message_size,
        _pargs_in->encrypt_aes_data,
        _pargs_in->encrypt_aes_data_size,
        _pargs_in->mrenclave,
        _pargs_in->mrenclave_size);
...
static void ecall_seal_state_data(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    seal_state_data_args_t* _pargs_in = (seal_state_data_args_t*)input_buffer;
    seal_state_data_args_t* _pargs_out = (seal_state_data_args_t*)output_buffer;
    ...
    if (_pargs_in->sealed_data)
        OE_SET_OUT_POINTER(sealed_data, 1, sizeof(sealed_data_t*), sealed_data_t**);
    if (_pargs_in->sealed_data_size)
        OE_SET_OUT_POINTER(sealed_data_size, 1, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = seal_state_data(
        _pargs_in->sealPolicy,
...
static void ecall_unseal_state_data(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    unseal_state_data_args_t* _pargs_in = (unseal_state_data_args_t*)input_buffer;
    unseal_state_data_args_t* _pargs_out = (unseal_state_data_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->sealed_data)
        OE_SET_IN_POINTER(sealed_data, 1, _pargs_in->sealed_data_size, sealed_data_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->data)
        OE_SET_OUT_POINTER(data, 1, sizeof(unsigned char*), unsigned char**);
    if (_pargs_in->data_size)
        OE_SET_OUT_POINTER(data_size, 1, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = unseal_state_data(
        _pargs_in->sealed_data,
        _pargs_in->sealed_data_size,
        _pargs_in->data,
        _pargs_in->data_size);
...
static void ecall_aes_decrypt_server_messages(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    aes_decrypt_server_messages_args_t* _pargs_in = (aes_decrypt_server_messages_args_t*)input_buffer;
    aes_decrypt_server_messages_args_t* _pargs_out = (aes_decrypt_server_messages_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (_pargs_in->reply_data)
        OE_SET_IN_POINTER(reply_data, _pargs_in->reply_data_size, sizeof(uint8_t), uint8_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (_pargs_in->is_ready)
        OE_SET_OUT_POINTER(is_ready, 1, sizeof(size_t), size_t*);
    ...
    /* Call user function. */
    _pargs_out->oe_retval = aes_decrypt_server_messages(
        _pargs_in->reply_data,
        _pargs_in->reply_data_size,
        _pargs_in->is_ready);
...
oe_ecall_func_t oe_ecalls_table[] = {
    ...
    (oe_ecall_func_t) ecall_verify_evidence,
    (oe_ecall_func_t) ecall_rsa_encrypt_aes_key,
    (oe_ecall_func_t) ecall_aes_encrypt_client_messages,
    (oe_ecall_func_t) ecall_seal_state_data,
    (oe_ecall_func_t) ecall_unseal_state_data,
    (oe_ecall_func_t) ecall_aes_decrypt_server_messages,
    ...
    unsigned char* sealed_data)
{
    ...
    /* Marshalling struct. */
    seal_host_write_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    _args.sealed_data = (unsigned char*)sealed_data;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(seal_host_write_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(seal_host_write_args_t));
    if (sealed_data)
    ...
    _pargs_in = (seal_host_write_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_host_function(
             attestation_fcn_id_seal_host_write,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (seal_host_write_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    *_retval = _pargs_out->oe_retval;
    ...
    OE_READ_OUT_PARAM(sealed_data, 1, sizeof(unsigned char));
