...
oe_result_t rsa_encrypt_aes_key(
    oe_enclave_t* enclave,
    int* _retval,
...
oe_result_t aes_encrypt_client_messages(
    oe_enclave_t* enclave,
    int* _retval,
...
oe_result_t aes_decrypt_server_messages(
    oe_enclave_t* enclave,
    int* _retval,
    uint8_t* reply_data,
